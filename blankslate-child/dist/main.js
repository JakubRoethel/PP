...
/* harmony import */ var _modules_googlemaps__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/googlemaps */ "./src/js/modules/googlemaps.js");
...
new _splidejs_splide__WEBPACK_IMPORTED_MODULE_5__["default"](".splide", {
  ...
  AutoScroll: _splidejs_splide_extension_auto_scroll__WEBPACK_IMPORTED_MODULE_6__.AutoScroll
});
...
function dropDownSearch() {
  ...
  var filters = document.querySelectorAll(".partner-template .wpc-filters-section");
  console.log("filters");
  console.log(filters);
  filters.forEach(function (filter) {
    var labelContainer = filter.querySelector(".widget-title ");
    var ulElement = filter.querySelector(".wpc-filters-ul-list");
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ gMapsService)
/* harmony export */ });
function gMapsService() {
  ...
  (function ($) {
    ...
    function add_marker($marker, map) {
      ...
      var iconBase = "/wp-content/themes/blankslate-child/assets/";
    ...
    var partnerDivs = document.querySelectorAll(".partner-card");

    // Add click event listeners to the partner divs
    partnerDivs.forEach(function (partnerDiv) {
      partnerDiv.addEventListener("click", function () {
        var lat = parseFloat(partnerDiv.getAttribute("data-lat"));
        var lng = parseFloat(partnerDiv.getAttribute("data-lng"));
        var title = partnerDiv.getAttribute("data-title");
        console.log(title);
        ...
        var markerToOpen = findMarkerByCoordinates(map.markers, lat, lng);
        var infowindow = new google.maps.InfoWindow({
          content: title
        });
