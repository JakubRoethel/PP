...
?>
    <div class="search-form-wrapper">
        ...
        <a href="#" class="submit" id="submit-link" data-base-url="<?php echo esc_url($base_url); ?>">Pokaz wyniki</a>
    </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            checkboxesLocation.forEach(checkboxLocation => {
